...
interface UserStore {
	...
	completePerspective: (storyId: string, charId: string, choiceRate: number, completedNodes: number) => void;
...
export const useUserStore = create<UserStore>()(
	persist(
		(set, get) => ({
			...
			completePerspective: (storyId, charId, choiceRate, completedNodes) => {
