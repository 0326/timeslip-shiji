...
export const wudiInkStories: Record<string, InkStoryConfig> = {
	...
	"huangdi:banquan": {
		...
		deaths: {
			...
			supply: {
				reason: "只懂杀伐以胜、不修德以服人，成一方霸主而非服万民的共主",
				classical: "轩辕乃修德振兵，治五气，艺五种，抚万民，度四方……以与炎帝战于阪泉之野。三战，然后得其志。",
				analysis:
					"史上的黄帝是『修德振兵』——先修德、抚万民，才用兵，故『诸侯咸来宾从』。阪泉三战能胜，靠的不只是兵锋，更是德让炎帝之众心服。你只逞杀伐之威，胜了也是霸而非王，众人口服心不服，共主之名便立不起来呀。",
			},
		},
		endings: {
			canon: {
	...
	"huangdi:zhuolu": {
		...
		deaths: {
			...
			scout: {
				reason: "斥候不明、雾中失察，被蚩尤合围，士气低落而败",
				classical: "蚩尤作乱，不用帝命。于是黄帝乃征师诸侯，与蚩尤战于涿鹿之野，遂禽杀蚩尤。",
				analysis:
					"涿鹿之战，蚩尤据雾而战、凶焰正盛。史上的黄帝是『征师诸侯』、合四方之力，更把雾中伏兵提防到了十二分。你斥候不备、雾散之时才发现四面包来，再勇的军心也架不住四面受敌——败不在勇，在失了先机呀。",
			},
			exile: {
				reason: "胜而不决、当断不断，坐失立威之机，共主之名大打折扣",
				classical: "蚩尤最为暴，莫能伐……遂禽杀蚩尤。而诸侯咸尊轩辕为天子，代神农氏，是为黄帝。",
				analysis:
					"涿鹿之胜，是天下把『主』交到你手里的那一刻。诸侯要的，是一个立得住、敢断言的共主。你两仗打赢却犹犹豫豫、当断不断，威是立了七分、泄了三分——共主的分量，就是这样被犹豫一点一点磨掉的呀。",
			},
		},
		endings: {
			canon: {
	...
	"huangdi:zhitianxia": {
		...
		deaths: {
			...
			jiuzhou: {
				reason: "虽有定九州之远见，却操之过急、根基未稳，共主之统先散",
				classical: "置左右大监，监于万国。万国和，而鬼神山川封禅与为多焉。获宝鼎，迎日推策。",
				analysis:
					"史上的黄帝『置左右大监，监于万国』，定九州是水到渠成、一步一步走出来的。你立意虽好，却恨不能一日划尽天下，政令太急、根基未稳，共主之统便像没扎稳的墙，一推就散呀。",
			},
			compromise: {
				reason: "想两全其美反两头落空，德政处处打折，民心未真正归服",
				classical: "举风后、力牧、常先、大鸿以治民。顺天地之纪，幽明之占……时播百谷草木。",
				analysis:
					"垂衣治天下，从来不是讨所有人欢喜。史上的黄帝举贤臣、顺天时、播百谷，该立规矩时绝不含糊。你想谁都不得罪，反倒谁都没真服——德若处处打折，便不是德，是纵容了呀。",
			},
			gaoyang: {
				reason: "身后传承处置失当，帝位相争，天下虽安却裂痕暗生",
				classical: "黄帝崩，葬桥山。其孙昌意之子高阳立，是为帝颛顼也。",
				analysis:
					"黄帝一脉，高阳（颛顼）与玄嚣两支各承其统。史上的继承尚能平稳过渡，靠的是生前早有安排。你身后两脉势同水火，天下表面上还安着，内里却已裂开了一道缝——盛世的裂痕，往往就藏在传承这一步里呀。",
			},
		},
		endings: {
			canon: {
	...
	"jie:wangguo": {
		...
		deaths: {
			...
			ao: {
				reason: "傲慢召见商汤，反被汤窥尽虚实，递了情报",
				classical: "夏桀不务德而武伤百姓，百姓弗堪。……汤修德，诸侯皆归汤。",
				analysis:
					"史上桀召汤而囚之夏台，本是想用威压震一震这位归心日众的诸侯。可他错在低估了汤——汤是带着一双眼睛来，把你的虚实看得一清二楚再走的。你那份傲慢，不是摆给商看的，是递到商手里的一张底牌呀。",
			},
			silent: {
				reason: "既不杀谏臣也不改荒政，僵在原地，坐视夏朝一寸寸倾颓",
				classical: "桀不务德而武伤百姓，百姓弗堪。汤乃兴师率诸侯，伊尹从汤，汤自把钺以伐昆吾，遂伐桀。",
				analysis:
					"夏之亡不在谏臣多，在桀明知天下人等着他转身，却一动不动。不杀谏臣是没魄力，不改荒政是没担当——两头都不做，等于两头都错。亡国的不是昏招，是僵在原地，看着国一寸寸塌下去也不肯伸手扶一把呀。",
			},
			exile: {
				reason: "不杀而辱谏臣，夏台噤声如坟，鸣条之战军心已散",
				classical: "桀既死，汤乃践天子位，代夏而王天下。",
				analysis:
					"不杀而辱，比杀更让人寒心——让忠臣活着，却堵住他们的嘴，夏台便是一座活着的坟墓。等鸣条之战打响，你的军队已经不知道为什么而战了。军心这东西，不是召之即来的，是平日里一点一滴攒下的呀。",
			},
		},
		endings: {
			canon: {
			...
			if_jinggao: {
				title: "加税示警",
				kind: "if",
				epigraph: "你用权力的刀守住了几年太平，可商在暗处积蓄，诸侯在怕中等待——夏的末路，只是被稍稍推迟了一些。",
			},
			if_rangxian: {
				title: "让贤存祀",
				kind: "if",
