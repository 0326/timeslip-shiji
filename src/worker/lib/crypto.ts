// 密码哈希与验证：使用 Web Crypto API (PBKDF2-SHA256)
...
// ── 极简 JWT（HS256，Hono 原生 jwt 中间件依赖 Web Crypto，这里自实现以避免兼容问题）──
...
export function extractToken(auth: string | undefined): string | null {
	if (!auth) return null;
